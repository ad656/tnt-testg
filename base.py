...
caPath = "c:/Python310/TNT/AWS_cert/AmazonRootCA1.pem"
certPath = "c:/Python310/TNT/AWS_cert/certificate.pem.crt"
keyPath = "c:/Python310/TNT/AWS_cert/private.pem.key"
...
class logger:
    ...
    def updateBLEGatewayConfig(self,gwId, cmd):
        url = "https://api.tagntrac.io/device/{0}/config".format(gwId)
        headers = {
...
outFile = open('c:\\Python310\\TNT\\{0}_{1}_{2}.log'.format(GW,name_devlist,int(time.time())), 'a')
#outFile = sys.stdout
...
if __name__=="__main__":
    ...
    for devlist in fname_devlist:
        with open(f'c:\\Python310\\TNT\\{devlist}', 'r') as fname:
...
##                 'C46A7CF90016','C46A7CF90017']
    ...
    fprint("Gateway: ", GW, name_devlist )
